<template>
  <div>
    ...
    <div class="pt-20 px-6">
      ...
      <!-- Sign Out Button -->
      <div v-if="isDataAvailable" class="mt-6 text-center">
        <button @click="signOut" class="bg-red-500 text-white py-2 px-6 rounded-lg hover:bg-red-600 transition duration-300">Sign out</button>
      </div>
    </div>
  </div>
</template>
